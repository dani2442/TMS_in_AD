...
def plot_results_exploration_a():
    plt.figure()
    plt.plot(res_df["a"], res_df["fc_pearson"], label="FC")
    plt.plot(res_df["a"], res_df["phfcd_ks"], label="phFCD")
...
data = [[sim.parameters.a, fc_pearson, phfcd_ks]]
columns = ["a", "fc_pearson", "phfcd_ks"]
