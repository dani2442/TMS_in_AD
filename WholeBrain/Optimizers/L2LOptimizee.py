...
class WholeBrainOptimizee(Optimizee):
    ...
    def simulate_(self):
        ...
        return result  # For the @loadOrCompute wrapper to work, all WholeBrain should return dicts
    ...
    def simulate(self, trajectory):
        ...
        fitness = self.simulate_(filename)[measure.name]  # For the @loadOrCompute wrapper to work, all WholeBrain should return dicts
...
if __name__ == "__main__":
    def main():
        ...
        traj.individual = dict(optimizee.create_individual())
